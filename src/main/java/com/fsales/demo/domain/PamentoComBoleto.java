...
public class PamentoComBoleto extends  Pagamento implements Serializable {
    ...
    public PamentoComBoleto(EstadoPagamento estado, Pedido pedido, Date dataVencimento, Date dataPagamento) {
        super(estado, pedido);
